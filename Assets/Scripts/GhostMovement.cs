...
/// </summary>
public class GhostMovement : MovementMode
{
    ...
    {
        Vector3 moveVector = GetMoveVector(inputs);
        char_controller.Move(moveVector * Time.deltaTime);
    }

    private Vector3 GetMoveVector(List<float> inputs)
    {
